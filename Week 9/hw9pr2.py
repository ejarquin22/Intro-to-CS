...
def inarow_3east(ch, r_start, c_start, A):
    '''inarow_3east will return True if there is are three chars in a row
        that are the same going eastward, and returns False otherwise.
        argument ch: a string
        argument r_start: int
        argumetn c_ start: int
        argument A: list
    '''
...
def inarow_3south(ch, r_start, c_start, A):
    '''inarow_3south will return True if there is are three chars in a row
        that are the same going southward, and returns False otherwise.
        argument ch: a string
        argument r_start: int
        argumetn c_ start: int
        argument A: list
...
def inarow_3southeast(ch, r_start, c_start, A):
    '''inarow_3southeast will return True if there is are three chars in a row
        that are the same going southeastward, and returns False otherwise.
        argument ch: a string
        argument r_start: int
        argumetn c_ start: int
        argument A: list
...
def inarow_3northeast(ch, r_start, c_start, A):
    '''inarow_3northeast will return True if there is are three chars in a row
        that are the same going northeastward, and returns False otherwise.
        argument ch: a string
        argument r_start: int
        argumetn c_ start: int
        argument A: list
...
def inarow_Neast(ch, r_start, c_start, A, N):
    '''inarow_Neast will return True if there is are three chars in a row
        that are the same going northeastward, and returns False otherwise.
        argument ch: a string
        argument r_start: int
        argumetn c_ start: int
...
def inarow_Nsouth(ch, r_start, c_start, A, N):
    '''inarow_Nsouth will return True id there is are three chars in a row
        that are the same going northeastward, and returns False otherwise.
        argument ch: a string
        argument r_start: int
        argumetn c_ start: int
...
def inarow_Nsoutheast(ch, r_start, c_start, A, N):
    '''inarow_Nsouthheast will return True if there is are three chars in a row
        that are the same going northeastward, and returns False otherwise.
        argument ch: a string
        argument r_start: int
        argumetn c_ start: int
...
def inarow_Nnortheast(ch, r_start, c_start, A, N):
    '''inarow_Nnortheast will return True if there is are three chars in a row
        that are the same going northeastward, and returns False otherwise.
        argument ch: a string
        argument r_start: int
        argumetn c_ start: int
