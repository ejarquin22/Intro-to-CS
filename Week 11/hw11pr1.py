...
wallC = box(pos = vector(0, 0, 10), axis = vector(-1, 0, 0), size = vector(20, 1, .2), color = color.green)
wallD = box(pos = vector(10, 0, 0), axis = vector(0, 0, -1), size = vector(20, 1, .2), color = color.red)
