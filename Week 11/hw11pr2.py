...
class Board:
    ...
    def colsToWin(self, ox):
        '''returns a list of columns that would lead to a win in the next move
        '''
        i = []
    ...
    def aiMove(self, ox):
        '''aiMove will play the best move by looking one move ahead
            if the ai can win, it will make that move, if the opponent can win
            if will block it from doing so.
        '''
        if ox == 'X':
            if self.colsToWin('X') != []:
                ...
                if self.colsToWin('O') != []:
                    ...
                    if self.allowsMove(0):
                        return 0
                    if self.allowsMove(1):
                        return 1
                    if self.allowsMove(2):
                        return 2
                    if self.allowsMove(3):
                        return 3
                    if self.allowsMove(4):
                        return 4
                    if self.allowsMove(5):
                        return 5
                    if self.allowsMove(6):
                        return 6
        if ox == 'O':
            if self.colsToWin('O') != []:
                return random.choice(self.colsToWin('O'))
